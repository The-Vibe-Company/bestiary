  ...
  ({ className = '', label, error, type = 'text', ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        ...
        <div className="relative">
          ...
          {isPassword && (
            <button
              ...
              className="absolute right-0 top-1/2 -translate-y-1/2 text-[var(--ivory-dark)] hover:text-[var(--ivory)] transition-colors"
            >
              {showPassword ? (
        ...
        {error && <p className="mt-1 text-sm text-[var(--burnt-amber)]">{error}</p>}
      </div>
    )
  }
)
